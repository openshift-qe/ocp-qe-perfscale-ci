...
def main():
	...
	for entry in QUERIES:
		...
		RESULTS["data"].append(clean_data['metadata'])
		RESULTS["data"].extend(clean_data['values'])
...
if __name__ == '__main__':
	...
	parser.add_argument("--yaml-file", type=str, default='netobserv-ipfix-metrics.yaml', help='YAML file from which to source Prometheus queries - defaults to "netobserv-ipfix-metrics.yaml"')
