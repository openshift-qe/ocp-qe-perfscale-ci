...
pipeline {
    ...
    parameters {
        ...
        choice(
            name: 'WORKLOAD',
            choices: ['None', 'cluster-density-v2', 'node-density', 'node-density-heavy', 'pod-density', 'pod-density-heavy', 'max-namespaces', 'max-services', 'concurrent-builds', 'router-perf'],
            description: '''
